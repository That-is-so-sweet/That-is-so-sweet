...
export const EditEventModal: React.FC<EditEventModalProps> = ({ event, isLoading, onCancel, onConfirm }) => {
  ...
  return (
    <div style={{ position: "absolute", inset: 0, background: "rgba(26,18,8,0.55)", display: "flex", alignItems: "center", justifyContent: "center", padding: 20, zIndex: 200, overflowY: "auto", overflowX: "hidden", overscrollBehavior: "contain" }}>
      <div style={{ background: "#fff", borderRadius: "var(--radius-modal)", padding: 18, width: "100%", maxWidth: 380, maxHeight: "90%", overflowY: "auto", overflowX: "hidden", overscrollBehavior: "contain" }}>
